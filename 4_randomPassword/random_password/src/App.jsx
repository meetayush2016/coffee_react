...
function App() {
  ...
  return (
    ...
    <div className="bg-gray-700 w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 text-orange-500">
      <div className="flex shadow-md rounded-lg overflow-hidden mb-4 flex-row ">
        <input 
        type="text" 
        value={password} 
        className="outline-none w-full py-1 px-3 m-3 rounded-lg"  placeholder="Password"  
        ref={passwordRef}
        readOnly/>
        <button className="bg-blue-800 p-3 m-3 rounded-lg" 
